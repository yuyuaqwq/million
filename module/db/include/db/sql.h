...
MILLION_MSG_DEFINE(MILLION_DB_API, SqlUpdateMsg, (nonnull_ptr<const DbRow>) db_row, (uint64_t) old_db_version)
MILLION_MSG_DEFINE(MILLION_DB_API, SqlInsertMsg, (nonnull_ptr<const DbRow>) db_row)
