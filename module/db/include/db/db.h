...
MILLION_MSG_DEFINE(MILLION_DB_API, DbRowPullMsg, (const google::protobuf::Descriptor&) table_desc, (std::string) primary_key, (std::optional<DbRow>) db_row);
MILLION_MSG_DEFINE(MILLION_DB_API, DbRowPushMsg, (std::string) table_name, (std::string) primary_key, (nonnull_ptr<DbRow>) db_row);
