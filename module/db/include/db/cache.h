...
MILLION_MSG_DEFINE(MILLION_DB_API, CacheLockMsg, (std::string) key, (bool) success)
MILLION_MSG_DEFINE(MILLION_DB_API, CacheGetMsg, (std::string_view) primary_key, (nonnull_ptr<DbRow>) db_row, (bool) success)
MILLION_MSG_DEFINE(MILLION_DB_API, CacheSetMsg, (nonnull_ptr<const DbRow>) db_row)
