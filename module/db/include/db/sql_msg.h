...
MILLION_MSG_DEFINE(DB_CLASS_API, SqlUpdateMsg, (google::protobuf::Message*) proto_msg)
MILLION_MSG_DEFINE(DB_CLASS_API, SqlInsertMsg, (google::protobuf::Message*) proto_msg)
