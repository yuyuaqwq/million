#pragma once
    ...
    #ifdef __linux__
        #define MILLION_FUNC_API __attribute__((visibility("default")))
        ...
        #define MILLION_FUNC_API __declspec(dllexport)
